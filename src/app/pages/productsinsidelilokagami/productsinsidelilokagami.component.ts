...
@Component({
  selector: 'app-productsinsidelilokagami',
  templateUrl: './productsinsidelilokagami.component.html',
  styleUrls: ['./productsinsidelilokagami.component.scss']
})
export class ProductsinsidelilokagamiComponent implements OnInit {

  constructor(private router: Router) {
    document.getElementById("product").style.color="white";
  }

  image1 = "../../../assets/images/comingup/Lilo/Kagami/kagami.png";
  image2 = "../../../assets/images/comingup/Lilo/Kagami/kagami2.png";

  image1_large = "../../../assets/images/comingup/Lilo/Kagami/kagami.png";
  image2_large = "../../../assets/images/comingup/Lilo/Kagami/kagami2.png";
