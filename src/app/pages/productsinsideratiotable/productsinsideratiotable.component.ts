...
@Component({
  selector: 'app-productsinsideratiotable',
  templateUrl: './productsinsideratiotable.component.html',
  styleUrls: ['./productsinsideratiotable.component.scss']
})
export class ProductsinsideratiotableComponent implements OnInit {
