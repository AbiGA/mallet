...
@Component({
  selector: 'app-productsinsidemiscellaneouslouvre',
  templateUrl: './productsinsidemiscellaneouslouvre.component.html',
  styleUrls: ['./productsinsidemiscellaneouslouvre.component.scss']
})
export class ProductsinsidemiscellaneouslouvreComponent implements OnInit {
