...
@Component({
  selector: 'app-productsinsidelucernapick',
  templateUrl: './productsinsidelucernapick.component.html',
  styleUrls: ['./productsinsidelucernapick.component.scss']
})
export class ProductsinsidelucernapickComponent implements OnInit {
 ...
 image2 = "../../../assets/images/productinside/lucernacollection/pick/pick2.png";
 
 image1_large = "../../../assets/images/productinside/lucernacollection/pick/pick1.png";
 image2_large = "../../../assets/images/productinside/lucernacollection/pick/pick2.png";
 
 mainimage = "../../../assets/images/productinside/lucernacollection/pick/pick1.png";
