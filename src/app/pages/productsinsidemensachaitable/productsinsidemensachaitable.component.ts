...
@Component({
  selector: 'app-productsinsidemensachaitable',
  templateUrl: './productsinsidemensachaitable.component.html',
  styleUrls: ['./productsinsidemensachaitable.component.scss']
})
export class ProductsinsidemensachaitableComponent implements OnInit {

  constructor(private router: Router) {
    document.getElementById("product").style.color="white";
  }

  image1 = "../../../assets/images/comingup/Mensa/Chai table/chaitable.png";
  image2 = "../../../assets/images/comingup/Mensa/Chai table/chaitable2.png";
  image3 = "../../../assets/images/comingup/Mensa/Chai table/chaitable3.png";

  image1_large = "../../../assets/images/comingup/Mensa/Chai table/chaitable.png";
